...
<body class="bg-earth-50 dark:bg-gray-900 text-earth-900 dark:text-gray-100 font-sans min-h-screen transition-colors duration-300">
    ...
    <header class="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-50">
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                <!-- Left: Back, Logo & Navigation -->
                <div class="flex items-center gap-2 sm:gap-4">
                    <!-- Back to blog -->
                    <a href="./" class="text-gray-600 dark:text-gray-300 hover:text-forest-600 transition" title="Volver al blog">
                    ...
                    <nav class="hidden md:flex items-center gap-1 ml-2">
                        ...
                        <div class="relative" id="categoriesDropdown">
                            <button class="px-3 py-2 text-gray-600 dark:text-gray-300 hover:text-forest-600 dark:hover:text-forest-400 font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition flex items-center gap-1 text-sm" onclick="toggleCategoriesMenu()">
                                <span data-i18n="nav_categories">Categorías</span>
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                                </svg>
                            </button>
                            <div id="categoriesMenu" class="hidden absolute left-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl shadow-xl overflow-hidden z-50">
                                <a href="./?cat=huertos-urbanos" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">🌱 Huertos Urbanos</a>
                                <a href="./?cat=compostaje" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">🌿 Compostaje</a>
                                <a href="./?cat=riego" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">💧 Riego</a>
                                <a href="./?cat=plantas" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">🌻 Plantas</a>
                                <a href="./?cat=tecnologia" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">📱 Tecnología</a>
                                <a href="./?cat=noticias" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm">📰 Noticias</a>
                            </div>
                        </div>
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    <!-- Mobile Menu Button -->
                    <button id="blogMobileMenuBtn" class="md:hidden p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition" aria-label="Menu">
            ...
            <div id="blogMobileMenu" class="hidden md:hidden mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <div class="flex flex-col gap-2">
                    ...
                    <a href="./?cat=riego" class="px-6 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-sm">💧 Riego</a>
                    <a href="./?cat=plantas" class="px-6 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg text-sm">🌻 Plantas</a>
    ...
    <button id="scrollTopBtn" class="fixed bottom-24 right-6 z-50 w-12 h-12 bg-forest-600 hover:bg-forest-700 text-white rounded-full shadow-lg shadow-forest-600/30 flex items-center justify-center transition-all opacity-0 pointer-events-none" aria-label="Volver arriba">
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
