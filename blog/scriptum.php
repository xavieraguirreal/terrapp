    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <article class="max-w-3xl mx-auto">
            ...
            <div id="articleContent" class="hidden">
                ...
                <div id="editorialOpinion" class="bg-forest-50 dark:bg-forest-900/20 border-l-4 border-forest-600 p-6 rounded-r-xl mb-8">
                    <h3 class="text-lg font-bold text-forest-700 dark:text-forest-400 mb-3 flex items-center gap-2">
                        <span>🌱</span> Opinión Editorial TERRApp
                    </h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8">
                    <h3 class="text-lg font-semibold mb-4">¿Te gustó este artículo?</h3>
                ...
                <div class="bg-gray-100 dark:bg-gray-800 rounded-xl p-4 mb-8">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <a id="sourceLink" href="#" target="_blank" class="text-forest-600 hover:underline">Ver original</a>
                    </p>
                </div>
            ...
            <div id="articleNotFound" class="hidden text-center py-12">
                ...
                <h2 class="text-2xl font-bold text-gray-700 dark:text-gray-300 mb-2">Artículo no encontrado</h2>
                <p class="text-gray-500 mb-6">El artículo que buscas no existe o fue eliminado.</p>
                <a href="./" class="inline-block px-6 py-3 bg-forest-600 hover:bg-forest-700 text-white font-semibold rounded-lg transition">
                    Volver al blog
                </a>
            </div>
        </article>
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="text-center">
                <p class="text-gray-600 dark:text-gray-400 mb-4">
                    ¿Te interesa la agricultura urbana? <a href="../landing/" class="text-forest-600 hover:underline font-semibold">Conoce TERRApp</a>
                </p>
